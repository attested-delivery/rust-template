...
See [SECURITY.md](https://github.com/attested-delivery/rust-template/blob/main/SECURITY.md#verifying-release-artifacts) for the full verification reference.
