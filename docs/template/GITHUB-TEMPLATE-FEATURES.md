...
| Agent instructions | Yes | `AGENTS.md` (anywhere in repo; also read by Claude Code) | [Custom instructions for Copilot](https://docs.github.com/copilot/customizing-copilot/adding-custom-instructions-for-github-copilot) |
