...
- **Start with the rename** — always begin with "Rename rust_template/rust-template/attested-delivery to match this repo" so Copilot updates all references
