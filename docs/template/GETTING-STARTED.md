...
> You just created a repository from **attested-delivery/rust-template**. This guide walks you through every step from creation to your first green CI run.

---

## 1. Create Your Repository

- [ ] Go to [attested-delivery/rust-template](https://github.com/attested-delivery/rust-template) and click **"Use this template"** > **"Create a new repository"**.
...
|---|---|---|
| `attested-delivery/rust-template` | `your-org/your-repo` | `acme/my-awesome-crate` |
| `attested-delivery` | your GitHub owner | `acme` |
