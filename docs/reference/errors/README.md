...
|---|---|---|---|
| [Invalid input](https://attested-delivery.github.io/rust-template/errors/invalid-input/v1) | 400 | 2 | No |
| [Operation failed](https://attested-delivery.github.io/rust-template/errors/operation-failed/v1) | 500 | 1 | No |
...
holds the base (`https://attested-delivery.github.io/rust-template/errors` by default); every
