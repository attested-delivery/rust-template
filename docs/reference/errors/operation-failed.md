...
| Field      | Value                                                             |
|------------|-------------------------------------------------------------------|
| Type URI   | `https://attested-delivery.github.io/rust-template/errors/operation-failed/v1`    |
...
```json
{
  "type": "https://attested-delivery.github.io/rust-template/errors/operation-failed/v1",
  "title": "Operation failed",
  "status": 500,
