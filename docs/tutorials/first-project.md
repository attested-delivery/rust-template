...
from **attested-delivery/rust-template**, built it, run its test suite, added your very
...
1. Open [attested-delivery/rust-template](https://github.com/attested-delivery/rust-template).
...
| Placeholder | Becomes |
|---|---|
| `attested-delivery/rust-template` | `your-owner/hello-rust` |
